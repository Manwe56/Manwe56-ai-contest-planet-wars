...
public class PlanetWars {
	...
	sentFleets = new ArrayList<Fleet>();
	ParseGameState(gameStateString);
    }

    public List<Fleet> getSentFleets() {
		return sentFleets;
	}
	...
	return DistanceUtilities.getDistance(source, destination);
    }
    ...
    public void IssueOrder(int sourcePlanet,
        ...
        System.out.println("" + sourcePlanet + " " + destinationPlanet + " " +
          numShips);
	System.out.flush();
		int owner = GetPlanet(sourcePlanet).Owner();
		int distance = Distance(sourcePlanet, destinationPlanet);
		Fleet sent = new Fleet(owner, numShips, sourcePlanet, destinationPlanet, distance, distance);
		sentFleets.add(sent);
    }
